...
export const config = {
  ...
  SUBSCRIPTION_RENEWALS_ENABLED: parseBoolean(readConfigValue('SUBSCRIPTION_RENEWALS_ENABLED', 'true'), true),
  SUBSCRIPTION_RENEWALS_HOUR_UTC: parseNumber(readConfigValue('SUBSCRIPTION_RENEWALS_HOUR_UTC', '2'), 2),
  SUBSCRIPTION_RENEWALS_MAX_BUSINESSES: parseNumber(readConfigValue('SUBSCRIPTION_RENEWALS_MAX_BUSINESSES', '300'), 300),
  SUBSCRIPTION_RENEWAL_GRACE_DAYS: parseNumber(readConfigValue('SUBSCRIPTION_RENEWAL_GRACE_DAYS', '5'), 5)
};
